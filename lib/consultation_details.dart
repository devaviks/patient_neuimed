...
class ConsultationdetailsPage extends StatefulWidget {
  ...
  @override
  _ConsultationdetailsPageState createState() =>
          ...
          child: Column(
            children: [
                  ...
                  child: Container(
                    ...
                    decoration: ShapeDecoration(
                        ...
                        shape: RoundedRectangleBorder(
                            ...
                            side: BorderSide(
                                width: 1, color: Color(0xffB4B2B2)))),
                    child: Padding(
                        padding: EdgeInsets.only(
              ...
              Container(
                ...
                child: NeuiText(
                  text:
                      "In case of any issues or any requirement, you can call our\n"
                      "customer care.",
              ...
              Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        NeuiText(
                          text: "Do you want to download Prescription? ",
                          size: 14,
                          fontWeight: FontWeight.w600,
                          color: Colors.white,
                        ),
                        ...
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: Color(
                                0xff13CF62), // change text color of button
                          ),
                          child: NeuiText(
                            text: 'Download',
                            fontWeight: FontWeight.w600,
